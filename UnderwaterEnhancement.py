...
def compensate_RB(image, flag):
    ...
    # Compensate Red and Blue channel，补偿红色和蓝色通道
    if flag == 0:
        for i in range(y):
            for j in range(x):
...
#     image1 = Image.open(r'D:\Study\Ai\sklearn\Exercise_final\testimages\test_images\001488.jpg')
#     pcafused2, averagefused2 = underwater_image_enhancement(image1, image1, 0)
#     pcafused2.save('../pca001488.png')
#     averagefused2.save('../averagefused001488.png')